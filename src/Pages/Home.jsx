  ...
  <div className="space-y-2" data-aos="fade-up" data-aos-delay="600">
    <h1 className="text-5xl sm:text-6xl md:text-6xl lg:text-6xl xl:text-7xl font-bold tracking-tight">
      <span className="relative inline-block">
        ...
        <span className="relative bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:via-blue-100 dark:to-purple-200 bg-clip-text text-transparent">
          Frontend
        </span>
      </span>
      <br />
...
const TechStack = memo(({ tech }) => (
  <div className="px-4 py-2 hidden sm:block rounded-full bg-gray-200 dark:bg-white/5 backdrop-blur-sm border border-gray-300 dark:border-white/10 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-white/10 transition-colors">
    {tech}
  </div>
));
...
const SocialLink = memo(({ icon: Icon, link, label }) => (
  <a href={link} target="_blank" rel="noopener noreferrer" aria-label={label}>
    <button className="group relative p-3"
      ...
      <div className="relative rounded-xl bg-gray-100 dark:bg-black/50 backdrop-blur-xl p-2 flex items-center justify-center border border-gray-300 dark:border-white/10 group-hover:border-gray-400 dark:group-hover:border-white/20 transition-all duration-300">
        <Icon className="w-5 h-5 text-gray-600 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-gray-900 dark:text-white transition-colors" />
      </div>
    </button>
  </a>
));
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Site officiel et portfolio de Briwel DODAHO, Développeur Full-Stack. Expert en création d'expériences numériques innovantes avec NestJS, React, Flutter et Node.js." />
     <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://briweldodaho.com" />
        <meta property="og:title" content="Briwel DODAHO — Développeur Full-Stack" />
     <meta property="og:description" content="Site officiel et portfolio de Briwel DODAHO, Développeur Full-Stack." />
        <meta property="og:url" content="https://briweldodaho.com" />
      ...
      <div className="min-h-screen bg-white dark:bg-[#030014] overflow-hidden px-[5%] sm:px-[5%] lg:px-[10%]" id="Home">
              ...
              <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <p className="text-base md:text-lg text-gray-700 dark:text-gray-400 max-w-xl leading-relaxed font-light"
                    data-aos="fade-up"
                    data-aos-delay="1000">
                    Création d'applications web et mobiles innovantes, performantes et centrées sur l'utilisateur.
                  </p>
